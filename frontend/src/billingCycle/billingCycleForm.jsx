...
class BillingCycleForm extends Component {
    ...
    calculateSummary(){
        const sum = (t,v) => t + v
        return{
            sumOfCredits: this.props.credits? this.props.credits.map(c => +c.value || 0).reduce(sum): 0,
            sumOfDebts: this.props.debts ? this.props.debts.map(d => +d.value || 0).reduce(sum) : 0
        }
    }
            ...
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <Field name='month' component={LabelAndInput}
                        label='Mês' readOnly={readOnly} cols='12 4' placeholder='Informe o mês' />
                    <Field name='year' component={LabelAndInput}
                        label='Ano' readOnly={readOnly} cols='12 4' placeholder='Informe o ano' />
